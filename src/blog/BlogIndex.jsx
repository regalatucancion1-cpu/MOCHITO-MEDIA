    ...
    <div style={{ background: "#F5EEDC", minHeight: "100vh", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 2 }}>
          ...
          <span style={{ color: "#D4603E", fontSize: 13, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase", display: "block", marginBottom: 16 }}>Blog Mochito Media</span>
            ...
            {sorted.map(article => (
              <Link
                ...
                style={{
                  ...
                  boxShadow: "0 2px 12px rgba(42,30,24,0.04)",
                }}
                onMouseEnter={e => {
                  e.currentTarget.style.transform = "translateY(-4px)";
                  e.currentTarget.style.boxShadow = "0 12px 40px rgba(42,30,24,0.12)";
                  e.currentTarget.style.borderColor = "rgba(212,96,62,0.25)";
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.transform = "none";
                  e.currentTarget.style.boxShadow = "0 2px 12px rgba(42,30,24,0.04)";
                  e.currentTarget.style.borderColor = "rgba(42,30,24,0.08)";
                }}
              >
                <div style={{ display: "flex", gap: 12, marginBottom: 16, fontSize: 12, color: "#E5B24C", fontWeight: 600, textTransform: "uppercase", letterSpacing: 1 }}>
                  <span>{formatDate(article.date)}</span>
                  <span>·</span>
                  <span>{article.readTime} min</span>
                </div>
                <h2 style={{ fontSize: 22, fontWeight: 800, color: "#2A1E18", lineHeight: 1.25, margin: "0 0 14px", letterSpacing: "-0.5px" }}>
                  {article.title}
                </h2>
                <p style={{ fontSize: 15, color: "#475569", lineHeight: 1.65, margin: "0 0 24px", flexGrow: 1 }}>
                  {article.excerpt}
                </p>
                <span style={{ fontSize: 14, color: "#D4603E", fontWeight: 700, display: "inline-flex", alignItems: "center", gap: 6 }}>
